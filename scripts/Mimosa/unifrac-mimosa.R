...
mimosa_tree <- drop.tip(mimosa_tree, 
                        mimosa_tree$tip.label[!mimosa_tree$tip.label %in% colnames(mimosa_matrix)])
...
write.csv(file = "results/Mimosa/unifrac_matrix.csv", unifrac_matrix)
...
png("plots/Mimosa/upgma/unifrac_plot.png",
    height = 4, width = 4, units = 'in', res=300); unifrac_plot; dev.off()
cairo_pdf("plots/Mimosa/upgma/unifrac_dend.pdf", 
