...
#Saving results
write.csv(file = "results/Diplusodon/redundancy.csv", redundancy, row.names = FALSE)
...
#Loading results
redundancy <- read.csv("results/Diplusodon/redundancy.csv")
...
png("plots/Diplusodon/redundancy/redMean_plot.png",
