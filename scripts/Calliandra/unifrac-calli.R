...
png("C:/Users/Yago/Google Drive (souzayagob@alumni.usp.br)/New_phytologist-Ms/Figs/upgma/unifrac/calli.png",
    height = 4, width = 4, units = 'in', res=300); unifrac_plot; dev.off()
cairo_pdf("plots/Calliandra/upgma/unifrac_dend.pdf", 
