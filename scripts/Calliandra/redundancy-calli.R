...
calli_clean <- read.csv(file = "datasets/Calliandra/calli_clean.csv", na.strings = c("", NA))
...
#Saving results
write.csv(file = "results/Calliandra/redundancy.csv", redundancy, row.names = FALSE)
...
#Loading results
redundancy <- read.csv("results/Calliandra/redundancy.csv")
...
png("plots/Calliandra/redundancy/redMedian_plot.png",
...
png("plots/Calliandra/redundancy/redMean_plot.png",
