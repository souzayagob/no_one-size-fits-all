...
#Calculating PE
pe <- data.frame("id" = rownames(paep_matrix), 
                 "pe" = phyloendemism(paep_matrix, paep_tree, weighted = T)) 
...
set.seed(7)
null.output <- replicate(999, rand.matrix.pe(paep_tree, paep_matrix))
rownames(null.output) <- rownames(paep_matrix)
...
#Calculating PE
pe_comp <- data.frame("id" = rownames(paep_matrix), 
                      "pe_comp" = phyloendemism(paep_matrix, comp_tree, weighted = T)) 
...
set.seed(7)
null.output <- replicate(999, rand.matrix.pe(comp_tree, paep_matrix))
rownames(null.output) <- rownames(paep_matrix)
...
set.seed(7)
null.output <- replicate(999, rand.matrix.rpe(paep_tree, paep_matrix))
rownames(null.output) <- rownames(paep_matrix)
...
png("plots/Paepalanthus/canape/pe_plot.png",
    height = 4, width = 4, units = 'in', res=300); pe_plot; dev.off()
png("plots/Paepalanthus/canape/peP_plot.png",
    height = 4, width = 4, units = 'in', res=300); peP_plot; dev.off()
png("plots/Paepalanthus/canape/rpe_plot.png",
    height = 4, width = 4, units = 'in', res=300); rpe_plot; dev.off()
png("plots/Paepalanthus/canape/rpeP_plot.png",
    height = 4, width = 4, units = 'in', res=300); rpeP_plot; dev.off()
png("plots/Paepalanthus/canape/canape_plot.png",
