...
#Saving results
write.csv(file = "results/Paepalanthus/redundancy.csv", redundancy, row.names = FALSE)
...
#Loading results
redundancy <- read.csv("results/Paepalanthus/redundancy.csv")
...
png("plots/Paepalanthus/redundancy/redMean_plot.png",
