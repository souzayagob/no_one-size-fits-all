...
#Saving results
write.csv(file = "results/Minaria/redundancy.csv", redundancy, row.names = FALSE)
...
#Loading results
redundancy <- read.csv("results/Minaria/redundancy.csv")
...
png("plots/Minaria/redundancy/redMedian_plot.png",
...
png("plots/Minaria/redundancy/redMean_plot.png",
